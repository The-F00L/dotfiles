# Generated by Powerlevel10k configuration wizard on 2022-11-11 at 21:57 CET.
...
# flat heads, flat tails, 2 lines, disconnected, full frame, sparse, many icons,
...
() {
  ...
  typeset -g POWERLEVEL9K_BATTERY_DISCONNECTED_FOREGROUND='green'
